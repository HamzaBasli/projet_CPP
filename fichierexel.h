#ifndef FICHIEREXEL_H
#define FICHIEREXEL_H
...
class fichierExel: public QObject
{
    Q_OBJECT
public:
    fichierExel(const QString &filepath, const QString &sheettitle,
                          QTableView *tableview):excelFilePath(filepath),
                          sheetName(sheettitle), tableView(tableview){}

        ~fichierExel() {QSqlDatabase::removeDatabase("excelexport");}
